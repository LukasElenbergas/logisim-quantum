...
public class Value {
    ...
    public Value(Value val, QuantumValue qVal) {
        this(val.width, val.error, val.unknown, val.value);
        this.qVal = qVal;
    }
    ...
    public boolean equals(Object other_obj) {
        ...
        if (this.qVal == null && other.qVal == null) {
            return this.width == other.width
                    && this.error == other.error
                    && this.unknown == other.unknown
                    && this.value == other.value;
        } else if (this.qVal == null || other.qVal == null) {
            return false;
        } else {
            return this.width == other.width
                    && this.error == other.error
    ...
    public Color getColor() {
        if (error != 0) {
            ...
            else if (this.isQuantum()) return QUANTUM_COLOR;
    ...
    public boolean isQuantum() {
        return this.width == Value.QUANTUM.width
                && this.error == Value.QUANTUM.error
                && this.unknown == Value.QUANTUM.unknown
                && this.value == Value.QUANTUM.value;
    }
}
